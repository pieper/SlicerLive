...
const MORPHO: Record<string, Specimen> = {
  ...
  alligator:   { label: "Juvenile alligator — diceCT", url: "https://github.com/raranda22/Juvenile_Alligator_Volume/releases/download/v1/dinonoto-AM112911-05_Juv_Alligator-volume.nrrd", zarrBase: "https://js2.jetstream-cloud.org:8001/swift/v1/slicerlive/zarr/alligator/", preset: "diceCT_16", dims: [4634, 1120, 705], credit: "raranda22 / Juvenile_Alligator_Volume (MorphoDepot, CC-BY 4.0)" },
  xenopus:     { label: "Xenopus frog — diceCT", url: "https://github.com/isafinamor/sapo/releases/download/v1/dinonoto-Xenopus-diceCT-volume.nrrd", zarrBase: "https://js2.jetstream-cloud.org:8001/swift/v1/slicerlive/zarr/xenopus/", preset: "diceCT_16", dims: [1711, 1376, 705], credit: "isafinamor / sapo (MorphoDepot, CC-BY 4.0)" },
  stickleback: { label: "Three-spine stickleback — µCT", url: "https://github.com/CDonatelli/Gasterosteus_aculeatus_16um/releases/download/v1/Gasterosteus_aculeatus_15.9um.nrrd", zarrBase: "https://js2.jetstream-cloud.org:8001/swift/v1/slicerlive/zarr/stickleback/", preset: "Bat-8bit", dims: [904, 441, 3698], credit: "CDonatelli / Gasterosteus_aculeatus_16um (MorphoDepot, CC-BY 4.0)" },
  bat:         { label: "Dog-faced bat — µCT", url: "https://github.com/elisechmitchell/Para_dog-face_bat/releases/download/v1/C0008901_00000.nrrd", zarrBase: "https://js2.jetstream-cloud.org:8001/swift/v1/slicerlive/zarr/bat/", preset: "Bat-8bit", dims: [1262, 1733, 390], credit: "elisechmitchell / Para_dog-face_bat (MorphoDepot, CC-BY 4.0)" },
  poacher:     { label: "Poacher fish tail — µCT", url: "https://github.com/CDonatelli/DamagedPoacherTail/releases/download/v1/BathyCrush05Tail_8.8um_Al1__rec0170.nrrd", zarrBase: "https://js2.jetstream-cloud.org:8001/swift/v1/slicerlive/zarr/poacher/", preset: "Bat-8bit", dims: [560, 560, 1358], credit: "CDonatelli / DamagedPoacherTail (MorphoDepot, CC-BY 4.0)" },
