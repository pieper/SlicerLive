// Reusable axis-aligned ROI crop widget: a RoiBoxField wireframe + 15 draggable handles
...
export function createRoiWidget(lo: Vec3, hi: Vec3, opts: RoiWidgetOpts = {}): RoiWidget {
  ...
  // Move one face along its RAS axis, keeping the opposite face fixed; returns [newCenter, newHalf].
